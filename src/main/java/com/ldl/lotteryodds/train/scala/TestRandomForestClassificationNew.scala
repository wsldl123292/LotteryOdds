...
object TestRandomForestClassificationNew {
    def main(args: Array[ String ]) {
        ...
        val testRowDataLb = sc.textFile( "F:\\data\\lotteryodds\\test_lb_new.txt" )
        ...
        val testRowDataWl = sc.textFile( "F:\\data\\lotteryodds\\test_wl_new.txt" )
        ...
        val writerAll = new PrintWriter(new File("F:\\data\\lotteryodds\\result_all_new.txt" ))
